...
def write_markdown(path: Path, rows: list[dict]) -> None:
    ...
    lines = [
        ...
        f"- Legal now has one length-controlled alpha-4 seed6 run with positive forced-choice, activation, and recovered-vector deltas, but no normal-generation keyword lift. It is useful as a second mechanistic trait, not yet a clean prose-behavior replication.",
