...
APP_NAME = "pythia-subliminal-observable-emotion3-sweep"
REMOTE_ROOT = Path("/root/pythia-subliminal")
ARTIFACT_ROOT = Path("/artifacts")
ARTIFACT_VOLUME_NAME = "pythia-subliminal-artifacts"

EMOTIONS = ["vengeful", "amused", "relieved"]
LABEL = "observable_emotion3_seeded_random_1024"
...
def run_sweep() -> dict[str, object]:
    ...
    return {"label": LABEL, "emotions": EMOTIONS, "top": top[:10]}
