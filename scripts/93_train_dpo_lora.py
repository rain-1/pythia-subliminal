...
def main() -> None:
    ap = argparse.ArgumentParser(description="DPO-train a LoRA adapter on preference pairs.")
    ...
    save_config(run_cfg, output_dir / "config.yaml")
